...
https://github.com/colormono/playing-nextjs-tailwindcss
...
Performance benefits out of the box: **automatic code splitting** and **efficient code under the hood**.

**reportWebVitals**: set of useful metrics that aim to capture the user experience of a web page.
